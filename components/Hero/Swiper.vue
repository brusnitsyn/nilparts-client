  ...
  <Swiper :options="swiperOption" class="rounded-b-lg relative ">
    <SwiperSlide v-for="(slide) in slides" :key="slide.id">
      <div class="relative flex flex-col">
        ...
        <div class="relative mx-6 md:mx-16 max-w-[528px] pt-20 mb-10 text-white">
        ...
        <div v-if="slide.btn_text" class="mt-8 relative flex flex-col justify-end grow">
          <div class="flex items-center bg-white/[0.15] backdrop-blur-[140px] pl-6 md:pl-16 h-[100px] ">
