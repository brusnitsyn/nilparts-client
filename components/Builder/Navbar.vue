...
<template>
  <div
    ref="navbar"
    class="top-0 z-40 w-full flex-none lg:z-50 bg-white dark:bg-slate-900 sticky drop-shadow-md"
  >
    <div id="navbar-banner" class="banner">
      <slot name="banner" />
    </div>

    <div class="border-b border-gray-900/10 dark:border-gray-50/20">
                ...
                <Transition name="animation-search-panel">
                  ...
                  >
                    <div class="w-full h-full max-h-screen mx-auto">
                      <div
                        class="max-w-8xl absolute top-6 bottom-6 lg:top-10 lg:bottom-10 lg:left-8 lg:right-8 px-4 w-full lg:w-auto lg:mx-auto"
                      >
                        <div class="grid">
                          <div
                          ...
                          <div class="my-8" v-if="searchResult.length">
                            <div
                              class="grid md:grid-cols-2 items-start lg:grid-cols-4 gap-y-4 gap-x-4 h-[calc(100vh-14rem)] overscroll-y-contain overflow-y-auto scrollbar-hide lg:scrollbar-default"
                            >
                              <LazyCatalogItem
    ...
    <div class="hidden md:block max-w-8xl w-full mx-auto">
      <div class="py-3 lg:px-8 mx-4 lg:mx-0">
        <!-- submenu -->
        <slot name="submenu" />
      </div>
